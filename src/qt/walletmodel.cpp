...
WalletModel::SendCoinsReturn WalletModel::sendCoins(const QList<SendCoinsRecipient> &recipients, const CCoinControl *coinControl)
{
...

    {
		...
		//Peoples Reserve - Steven Segal - 1-24-2015
		wtx.SendersAddress = GetSendersAddress();
		printf("PeoplesReserve: Adding Cash Back Applicable TX %s",wtx.SendersAddress.c_str());
